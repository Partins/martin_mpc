///
/// Auto-generated TCP server for optimizer: navigation
/// Generated at: 2021-09-22 09:17:05.389587
///
...
const BIND_IP_DEFAULT: &str = "127.0.0.1";

/// Port
/// Can be overriden by the user
const BIND_PORT_DEFAULT: u32 = 8333;
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != NAVIGATION_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != NAVIGATION_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [navigation]")
        .version("0.0.0")
        .author("John Smith")
